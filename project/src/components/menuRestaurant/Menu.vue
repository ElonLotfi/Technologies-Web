        ...
        <div class="single-menu">
          ...
          <div class="menu-content">
            <h4>
              ...
              <div class="platName"><p class="menuNamme">Plat du jour  </p>{{ this.menuName }}</div>
            </h4>
            <p class="description">
         ...
         <div class="single-menu">
          ...
          <div class="menu-content">
            <h4>
            <div class="dessertName"><p class="menuNamme"> Dessert </p>{{ this.dessertName }}</div>
            </h4>
            <p class="description">{{this.dessertDiscription}}
             </p>
          </div>
        </div>
...
export default {
  ...
  methods: {
    generateMenu() {
      let menu = menuGenerator.generateMenu();
      this.menuName = menu[0];
      this.menuPic = menu[1];
      this.menuDiscription = menu[2];
